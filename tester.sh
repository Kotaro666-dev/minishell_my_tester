...
function run_test()
{
    MINI_RESULT=$(echo $@ "; exit" | ./minishell 2> /dev/null)
	MINI_STATUS=$?
    BASH_RESULT=$(echo $@ "; exit" | bash 2> /dev/null)
    BASH_STATUS=$?
    if [ "$MINI_RESULT" == "$BASH_RESULT" ] && [ "$MINI_STATUS" == "$BASH_STATUS" ]; then
    ...
    if [ "$MINI_RESULT" == "$BASH_RESULT" ] && [ "$MINI_STATUS" == "$BASH_STATUS" ]; then
        write_file ok_results.txt $@
    else
        write_file ko_results.txt $@
    fi
}
...
function write_file()
{
    echo "[COMMAND]: $2" >> $1
    echo "[OUTPUT]" >> $1
    echo "[MINI]: [$MINI_RESULT]" >> $1
    echo "[BASH]: [$BASH_RESULT]" >> $1
    echo "[STATUS]" >> $1
    echo "[MINI]: " $MINI_STATUS >> $1
    echo "[BASH]: " $BASH_STATUS >> $1
    echo "" >> $1
}
...
run_test 'echo hello >>'
run_test 'cat < '
run_test 'echo hello > > test1.txt'
run_test 'echo hello >> >> test1.txt'
run_test 'echo hello > >> test1.txt'
run_test 'echo hello > < test1.txt'
run_test 'cat < < test1.txt'
...
run_test "eChO 1 | cat -e"
run_test "ECHO 1 | cat -e"
run_test "unset PATH ; echo 1 | cat -e"
run_test "unset PATH ; ECHO 1 | cat -e"
...
run_test 'mkdir a b ; cd a ; cd ../b ; pwd ; cd .. ; pwd ; echo $PWD ; echo $OLDPWD ; rm -fr a b'
...
run_test 'mkdir a ; cd a ; rm -fr ../a ; cd ; pwd'
run_test 'mkdir a ; cd a ; rm -fr ../a ; cd "" ; pwd'
run_test 'mkdir a ; cd a ; rm -fr ../a ; cd . ; pwd'
run_test 'mkdir a ; cd a ; rm -fr ../a ; cd ./ ; pwd'
run_test 'mkdir a ; cd a ; rm -fr ../a ; cd ./././ ; pwd'
...
run_test 'mkdir a ; cd a ; rm -fr ../a ; cd .. ; pwd'
run_test 'mkdir a ; cd a ; rm -fr ../a ; cd ../ ; pwd'
run_test 'mkdir a ; cd a ; rm -fr ../a ; export HOME= PWD= OLDPWD= ; cd ; pwd ; echo $HOME $PWD $OLDPWD'
run_test 'mkdir a ; cd a ; rm -fr ../a ; export HOME= PWD= OLDPWD= ; cd "" ; pwd ; echo $HOME $PWD $OLDPWD'
run_test 'mkdir a ; cd a ; rm -fr ../a ; export HOME= PWD= OLDPWD= ; cd $HOME ; pwd ; echo $HOME $PWD $OLDPWD'
run_test 'mkdir a ; cd a ; rm -fr ../a ; export HOME= PWD= OLDPWD= ; cd . ; pwd ; echo $HOME $PWD $OLDPWD'
run_test 'mkdir a ; cd a ; rm -fr ../a ; export HOME= PWD= OLDPWD= ; cd . ; pwd ; echo $HOME $PWD $OLDPWD ; cd . ; pwd ; echo $HOME $PWD $OLDPWD'
run_test 'mkdir a ; cd a ; rm -fr ../a ; export HOME= PWD= OLDPWD= ; cd . ; pwd ; echo $HOME $PWD $OLDPWD ; cd . ; pwd ; echo $HOME $PWD $OLDPWD ; cd // ; pwd ; cd home ; pwd ; echo $HOME $PWD $OLDPWD'
run_test 'mkdir a ; cd a ; rm -fr ../a ; export HOME= PWD= OLDPWD= ; cd .. ; pwd ; echo $HOME $PWD $OLDPWD'
run_test 'cd /.// ; pwd'
run_test 'cd /./////././//// ; pwd'
run_test 'cd /// ; pwd'
...
run_test 'mkdir d ; ln -s d dd ; cd dd ; pwd ; rm -r ../d ../dd'
...
run_test "\"echo hello\""
run_test "'echo hello'"
run_test "\"  echo hello there my friend | cat    \""
run_test "'  echo hello there my friend | cat    '"
